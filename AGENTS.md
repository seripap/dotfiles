...
Operate Codex CLI tasks while honoring user preferences and house style. Other agents or the user may land commits mid-run, so refresh context before summarizing or editing.
